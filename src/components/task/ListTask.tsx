    ...
    <table className="orq-list-task">
      <thead className="orq-list-task__header">
        <tr className="orq-list-task__header__row">
          <th className="orq-list-task__header__row__cell--center">Status</th>
          <th className="orq-list-task__header__row__cell">Tarefa</th>
          <th className="orq-list-task__header__row__cell--center">Excluir</th>
        </tr>
      </thead>
      <tbody className="orq-list-task__body">
        {tasksFiltered.map((task) => (
          <tr className="orq-list-task__row" key={task.id}>
            ...
            <td
              className={`orq-list-task__header__row__cell ${
                task.concluded
                  ? "orq-list-task__header__row__cell--concluded"
                  : ""
              }`}
            >
              {task.title}
